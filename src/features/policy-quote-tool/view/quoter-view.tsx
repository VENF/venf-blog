...
export const QuoterPage = () => {
  return (
    <div className="grid h-[100vh] grid-cols-[1fr_1fr] gap-6 p-5">
      <div className="flex flex-col items-center justify-between p-1">
        <div className="flex h-[90%] flex-col items-center justify-between p-12">
          <div className="space-y-6">
            <span className="flex items-center gap-2 text-muted-foreground">
              <ShieldCog />
              Cotizador Inteligente de Salud
            </span>
            <h1 className="text-6xl font-bold">Tu poliza de salud sin complicaciones.</h1>
            ...
            <div className="mt-12 grid w-[80%] grid-cols-2 gap-3">
              {BULLETS.map((item, i) => (
        ...
        <div className="mb-[50px] grid grid-cols-2 gap-6 p-1">
          <div className="flex flex-col items-center justify-center">
            <h2 className="mb-2 text-6xl font-bold">100%</h2>
            <p className="w-[60%] text-center text-muted-foreground">
              Tarifas oficiales actualizadas en tiempo real.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center">
            <h2 className="mb-2 text-6xl font-bold">{'< 60s'}</h2>
            <p className="w-[60%] text-center text-muted-foreground">
      ...
      <div className="relative flex flex-col items-center overflow-hidden bg-[#F5F5F7]/50 dark:bg-background">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-[175px] border-l-2 border-dashed border-[#DAD9DE] dark:border-muted/50" />
        <div className="pointer-events-none absolute inset-y-0 right-[175px] border-r-2 border-dashed border-[#DAD9DE] dark:border-muted/50" />
        <QuoteFormSection />
        <div className="w-full border-2 border-t-0 border-r-0 border-l-0 border-dashed border-[#DAD9DE] dark:border-muted/50" />
        <div className="flex-1" />
      </div>
